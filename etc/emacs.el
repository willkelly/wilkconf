...
(message "Loading wilkconfig (doesn't do much, don't worry)")
...
(unless (boundp 'wilk-conf-dir)
  (defvar wilk-conf-dir 
    (or (getenv "WILKCONF") 
	(join-dirs (getenv "HOME") "wilkconf"))))

(unless (boundp 'autoload-dir)
  (defvar autoload-dir 
    (or (getenv "EMACS_AUTOLOAD_DIR") 
	(join-dirs wilk-conf-dir "etc" "emacs" "autoload"))))
